class RequirementsController < ApplicationController
  ...
  private
    ...
    def requirement_params
      params.require(:requirement).permit(:order, :text_brief, :text_full, :requirement_type, :obligation, :default, :requirements_template_id, :parent_id, enumerations_attributes: [:id, :requirement_id, :value])
    end
