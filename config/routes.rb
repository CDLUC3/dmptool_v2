Dmptool2::Application.routes.draw do
  ...
  namespace :api, :defaults => {:format => :json} do
    namespace :v1 do
      ...
      resources :requirements_templates, only: [:index, :show], path: :templates_for_institution
  ...
  get "institutions/usage_statistics", defaults: {format: 'json'}, to: "institutions#usage_statistics"
